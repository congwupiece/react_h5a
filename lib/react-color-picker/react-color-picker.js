(function(f) {
    ...
    return (function e(t, n, r) {
        ...
        "./lib/index.js": [function(require, module, exports) {
            ...
            "./components/colorpicker.react": "/Volumes/Home/Projects/react-colorpicker/lib/components/colorpicker.react.jsx"
        }],
        "/Volumes/Home/Projects/react-colorpicker/lib/components/colorpicker.react.jsx": [
            function(require, module, exports) {
                ...
                var OnChangeMixin = require(
                    '../mixin/onchange.react');
                ...
                var ColorPicker = React.createClass({
                    ...
                    componentWillReceiveProps: function(
                        ...
                        var nextColor = nextProps.color
                            .toLowerCase();
                        var currentColor = Colr.fromHsvObject(
                            this.state.hsv).toHex();

                        if (nextColor !==
                            currentColor) {
                            this.setState(this.getStateFrom(
                                nextProps.color
                            ));
                        }
                    },
                    ...
                    loadColor: function(color) {
                        this.setState(this.getStateFrom(
                            color));
                        this.props.onChange(Colr.fromHex(
                            color));
                    },

                    // update the current color using the raw hsv values
                    update: function() {
                        var color = Colr.fromHsvObject(
                            this.state.hsv);
                        this.setState({
                            color: color
                        });
                    ...
                    setSaturationAndValue: function(
                        saturation, value) {
                        this.state.hsv.s =
                            saturation;
                        this.state.hsv.v = value;
                    ...
                    getBackgroundHue: function() {
                        return Colr.fromHsv(this.state
                            .hsv.h, 100, 100).toHex();
                    },
                ...
                "../mixin/onchange.react": "/Volumes/Home/Projects/react-colorpicker/lib/mixin/onchange.react.jsx",
                "../util/react": "/Volumes/Home/Projects/react-colorpicker/lib/util/react.js",
                "./details.react": "/Volumes/Home/Projects/react-colorpicker/lib/components/details.react.jsx",
                "./map.react": "/Volumes/Home/Projects/react-colorpicker/lib/components/map.react.jsx",
                "./sample.react": "/Volumes/Home/Projects/react-colorpicker/lib/components/sample.react.jsx",
                "./slider.react": "/Volumes/Home/Projects/react-colorpicker/lib/components/slider.react.jsx",
                "classnames": "/Volumes/Home/Projects/react-colorpicker/node_modules/classnames/index.js",
                "colr": "/Volumes/Home/Projects/react-colorpicker/node_modules/colr/index.js"
            }
        ],
        "/Volumes/Home/Projects/react-colorpicker/lib/components/details.react.jsx": [
            function(require, module, exports) {
                'use strict';
                ...
                var Details = React.createClass({
                    ...
                    propTypes: {
                        color: React.PropTypes.instanceOf(
                            Colr).isRequired,
                ...
                "../mixin/onchange.react": "/Volumes/Home/Projects/react-colorpicker/lib/mixin/onchange.react.jsx",
                "../util/react": "/Volumes/Home/Projects/react-colorpicker/lib/util/react.js",
                "./input.react": "/Volumes/Home/Projects/react-colorpicker/lib/components/input.react.jsx",
                "colr": "/Volumes/Home/Projects/react-colorpicker/node_modules/colr/index.js"
            }
        ],
        "/Volumes/Home/Projects/react-colorpicker/lib/components/input.react.jsx": [
            function(require, module, exports) {
                'use strict';
        ...
        "/Volumes/Home/Projects/react-colorpicker/lib/components/map.react.jsx": [
            function(require, module, exports) {
                'use strict';

                var React = require('../util/react');
                var Colr = require('colr');
                var PureRenderMixin = require(
                    'react/lib/ReactComponentWithPureRenderMixin'
                );
                var classnames = require('classnames');

                var clamp = require('../util/clamp');
                var DraggableMixin = require(
                    '../mixin/draggable.react');
                var OnChangeMixin = require(
                    '../mixin/onchange.react');
                ...
                var Map = React.createClass({
                    ...
                    propTypes: {
                        ...
                        backgroundColor: React.PropTypes
                            .string.isRequired,
                    },

                    updatePosition: function(clientX,
                        clientY) {
                        var rect = this.getDOMNode()
                ...
                "../mixin/draggable.react": "/Volumes/Home/Projects/react-colorpicker/lib/mixin/draggable.react.jsx",
                "../mixin/onchange.react": "/Volumes/Home/Projects/react-colorpicker/lib/mixin/onchange.react.jsx",
                "../util/clamp": "/Volumes/Home/Projects/react-colorpicker/lib/util/clamp.js",
                "../util/react": "/Volumes/Home/Projects/react-colorpicker/lib/util/react.js",
                "classnames": "/Volumes/Home/Projects/react-colorpicker/node_modules/classnames/index.js",
                "colr": "/Volumes/Home/Projects/react-colorpicker/node_modules/colr/index.js",
                "react/lib/ReactComponentWithPureRenderMixin": "/Volumes/Home/Projects/react-colorpicker/node_modules/react/lib/ReactComponentWithPureRenderMixin.js"
            }
        ],
        "/Volumes/Home/Projects/react-colorpicker/lib/components/sample.react.jsx": [
            function(require, module, exports) {
                'use strict';
        ...
        "/Volumes/Home/Projects/react-colorpicker/lib/components/slider.react.jsx": [
            function(require, module, exports) {
                'use strict';
                ...
                var Slider = React.createClass({
                    ...
                    render: function() {
                        ...
                        var styles = {};
                        var attr = this.props.vertical ?
                            'bottom' : 'left';
                        styles[attr] = this.getPercentageValue(
                            this.props.value);
        ...
        "/Volumes/Home/Projects/react-colorpicker/lib/mixin/draggable.react.jsx": [
            function(require, module, exports) {
                'use strict';
                ...
                var DraggableMixin = {
                    ...
                    componentDidMount: function() {
                        document.addEventListener(
                            'mousemove', this.handleUpdate
                        );
                        document.addEventListener(
                            'touchmove', this.handleUpdate
                        );
                        document.addEventListener(
                            'mouseup', this.stopUpdates
                        );
                        document.addEventListener(
                            'touchend', this.stopUpdates
                        );
                    },
        ...
        "/Volumes/Home/Projects/react-colorpicker/lib/mixin/onchange.react.jsx": [
            function(require, module, exports) {
                'use strict';
        ...
        "/Volumes/Home/Projects/react-colorpicker/lib/util/clamp.js": [
            function(require, module, exports) {
        ...
        "/Volumes/Home/Projects/react-colorpicker/lib/util/react.js": [
            function(require, module, exports) {
        ...
        "/Volumes/Home/Projects/react-colorpicker/node_modules/classnames/index.js": [
            function(require, module, exports) {
                /*
        ...
        "/Volumes/Home/Projects/react-colorpicker/node_modules/colr/index.js": [
            function(require, module, exports) {
                'use strict';
                ...
                Colr.fromRgbArray = function(arr) {
                    return (new Colr()).fromRgb(arr[0], arr[
                        1], arr[2]);
                };

                Colr.fromRgbObject = function(obj) {
                    return (new Colr()).fromRgb(obj.r, obj.g,
                        obj.b);
                };
                ...
                Colr.fromHslArray = function(arr) {
                    return (new Colr()).fromHsl(arr[0], arr[
                        1], arr[2]);
                };

                Colr.fromHslObject = function(obj) {
                    return (new Colr()).fromHsl(obj.h, obj.s,
                        obj.l);
                };
                ...
                Colr.fromHsvArray = function(arr) {
                    return (new Colr()).fromHsv(arr[0], arr[
                        1], arr[2]);
                };

                Colr.fromHsvObject = function(obj) {
                    return (new Colr()).fromHsv(obj.h, obj.s,
                        obj.v);
                };
                ...
                Colr.prototype.fromRgbArray = function(arr) {
                    return this.fromRgb(arr[0], arr[1], arr[
                        2]);
                };
                ...
                Colr.prototype.fromHslArray = function(arr) {
                    return this.fromHsl(arr[0], arr[1], arr[
                        2]);
                };
                ...
                Colr.prototype.fromHsvArray = function(arr) {
                    return this.fromHsv(arr[0], arr[1], arr[
                        2]);
                };
                ...
                Colr.prototype.toRgbArray = function() {
                    var arr = this.toRawRgbArray();
                    return [Math.round(arr[0]), Math.round(
                        arr[1]), Math.round(arr[2])];
                };
                ...
                "colr-convert": "/Volumes/Home/Projects/react-colorpicker/node_modules/colr/node_modules/colr-convert/index.js"
            }
        ],
        "/Volumes/Home/Projects/react-colorpicker/node_modules/colr/node_modules/colr-convert/index.js": [
            function(require, module, exports) {
                'use strict';
                ...
                function hex2rgb(hex) {
                    ...
                    if (len - i < 3) {
                        throw new Error(
                            'hex input must be at least three chars long'
                        );
                    }
                    ...
                    if (len - i >= 6) {
                        r = (h1 << 4) + h2;
                        g = (h3 << 4) + hexVal(hex.charCodeAt(3 +
                            i));
                        b = (hexVal(hex.charCodeAt(4 + i)) << 4) +
                            hexVal(hex.charCodeAt(5 + i));
                    } else {
                        r = (h1 << 4) + h1;
                        g = (h2 << 4) + h2;
                        b = (h3 << 4) + h3;
                ...
                function rgb2grayscale(rgb) {
                    return (rgb[0] * 299 + rgb[1] * 587 + rgb[2] *
                        114) / 1000;
                }

            }, {}
        ],
        "/Volumes/Home/Projects/react-colorpicker/node_modules/react/lib/ReactComponentWithPureRenderMixin.js": [
            function(require, module, exports) {
                /**
                ...
                "./shallowEqual": "/Volumes/Home/Projects/react-colorpicker/node_modules/react/lib/shallowEqual.js"
            }
        ],
        "/Volumes/Home/Projects/react-colorpicker/node_modules/react/lib/shallowEqual.js": [
            function(require, module, exports) {
                /**
                 * Copyright 2013-2015, Facebook, Inc.
                 * All rights reserved.
                ...
                function shallowEqual(objA, objB) {
                    ...
                    for (key in objB) {
                        if (objB.hasOwnProperty(key) && !objA.hasOwnProperty(
                                key)) {
                            return false;
                        }
                    }
